...
# Also found some efforts off: 5028 needs to pass effort to 5029 and be removed, 6820 needs to pass its effort to 6821 and be removed. This is done below in the final effort table, but could probably be done in the effort script. 
```
