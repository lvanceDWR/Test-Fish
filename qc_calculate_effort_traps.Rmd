...
sample <- read.csv("Data/Sample_20220510.csv")
effort <- read.csv("Data/TrapEffort_20220510.csv")
...
```{r}
write.csv(sampeffort.hours, file = "Data/YBFMP_TrapHours_2010_2021.csv", row.names = FALSE)
```
